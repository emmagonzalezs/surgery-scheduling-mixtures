...
if __name__ == '__main__':
    surgery_scheduling = SurgeryScheduling(number_surgeries=400, distr="normal", number_of_ors=3)
    ...
    #
        ...
        regret_results_alternate = pool.apply_async(run_regret_based, (surgery_scheduling, 100, 5, 'alternate'))
